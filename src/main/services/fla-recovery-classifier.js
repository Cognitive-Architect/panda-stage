...
/**
 * FLA V1.5 C2/C3 structural recovery classifier.
 *
 * This is the single bounded classifier core used by production Main and the
 * C2 research harness. It reads bytes, measures a classic ZIP/XFL layout, and
 * returns an explicit state plus reason codes. It never mutates its input and
 * never performs decompression or Project/UI work.
 */
