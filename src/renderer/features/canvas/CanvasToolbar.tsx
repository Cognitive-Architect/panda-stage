...
/**
 * Lightweight Canvas viewport chrome. The two viewport mode controls
 * (适应窗口 / 实际尺寸) live in the right-side 工具 surface
 * (ProjectToolsDrawer > 画布). The Canvas keeps only the compact
